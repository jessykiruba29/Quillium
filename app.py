...
def translate_text(text, target_lang):
    ...
    prefix_map = {
        ...
        "Malayalam": ">>mal<< ", "Bengali": ">>ben<< ",
        "Marathi": ">>mar<< ", "Gujarati": ">>guj<< ",
        "Punjabi": ">>pan<< ", "Urdu": ">>urd<< "
    }
...
def main():
    ...
    indian_languages = ["English", "Hindi", "Tamil", "Telugu", "Kannada", "Malayalam", 
                       "Bengali", "Marathi", "Gujarati", "Punjabi", "Urdu"]
    
    lang_choice = st.sidebar.selectbox("🌐 Choose Language", indian_languages)
    ...
    if uploaded_file:
        ...
        <div style='background: rgba(56, 239, 125, 0.05); border: 1px solid rgba(56, 239, 125, 0.3); border-radius: 16px; padding: 40px; text-align: center; margin: 20px 0;'>
            ...
            Upload a PDF to create interactive quizzes and flashcards in your preferred Indian language.
            </p>
        </div>
        """, unsafe_allow_html=True)
